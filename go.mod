module github.com/calebhiebert/go-vue-template

go 1.17

replace github.com/datomar-labs-inc/FCT_Helpers_Go => ./FCT_Helpers_Go
...
require (
	...
	github.com/datomar-labs-inc/FCT_Helpers_Go v0.0.8
