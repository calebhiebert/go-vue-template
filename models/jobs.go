...
var JobWhere = struct {
	...
	FailureData whereHelpernull_JSON
	MaxRetries  whereHelperint
	...
	Priority:    whereHelperint{field: "\"jobs\".\"priority\""},
	Source:      whereHelpernull_String{field: "\"jobs\".\"source\""},
	Data:        whereHelpernull_JSON{field: "\"jobs\".\"data\""},
	RunAt:       whereHelpernull_Time{field: "\"jobs\".\"run_at\""},
	FailureData: whereHelpernull_JSON{field: "\"jobs\".\"failure_data\""},
	MaxRetries:  whereHelperint{field: "\"jobs\".\"max_retries\""},
	RetryCount:  whereHelpernull_Int{field: "\"jobs\".\"retry_count\""},
	Status:      whereHelperstring{field: "\"jobs\".\"status\""},
	FinishedAt:  whereHelpernull_Time{field: "\"jobs\".\"finished_at\""},
	CreatedAt:   whereHelpernull_Time{field: "\"jobs\".\"created_at\""},
}
...
var (
	jobAllColumns            = []string{"id", "type", "priority", "source", "data", "run_at", "failure_data", "max_retries", "retry_count", "status", "finished_at", "created_at"}
	jobColumnsWithoutDefault = []string{"id", "type", "source", "data", "run_at", "failure_data", "retry_count", "finished_at"}
	jobColumnsWithDefault    = []string{"priority", "max_retries", "status", "created_at"}
...
// CountG returns the count of all Job records in the query, and panics on error.
