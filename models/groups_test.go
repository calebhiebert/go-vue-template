...
func testGroupsQuerySoftDeleteAll(t *testing.T) {
	t.Parallel()
	...
	if rowsAff, err := Groups().DeleteAll(ctx, tx, false); err != nil {
		t.Error(err)
	} else if rowsAff != 1 {
		t.Error("should only have deleted one row, but affected:", rowsAff)
	}
...
func testGroupsSliceSoftDeleteAll(t *testing.T) {
	t.Parallel()
...
func testGroupsQueryDeleteAll(t *testing.T) {
	...
	if rowsAff, err := Groups().DeleteAll(ctx, tx, true); err != nil {
		t.Error(err)
	} else if rowsAff != 1 {
		t.Error("should only have deleted one row, but affected:", rowsAff)
	}
...
func testGroupToManyGroupUsers(t *testing.T) {
	var err error
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	slice := GroupSlice{&a}
	if err = a.L.LoadGroupUsers(ctx, tx, false, (*[]*Group)(&slice), nil); err != nil {
		t.Fatal(err)
	}
...
func testGroupToManyInvites(t *testing.T) {
	var err error
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	slice := GroupSlice{&a}
	if err = a.L.LoadInvites(ctx, tx, false, (*[]*Group)(&slice), nil); err != nil {
		t.Fatal(err)
	}
...
func testGroupToManyAddOpGroupUsers(t *testing.T) {
	var err error
...
func testGroupToManyAddOpInvites(t *testing.T) {
	var err error
...
func testGroupToManySetOpInvites(t *testing.T) {
	var err error
...
func testGroupToManyRemoveOpInvites(t *testing.T) {
	var err error
...
func testGroupToOneUserUsingCreatedBy(t *testing.T) {
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	if err = local.L.LoadCreatedBy(ctx, tx, false, (*[]*Group)(&slice), nil); err != nil {
		t.Fatal(err)
	}
...
func testGroupToOneSetOpUserUsingCreatedBy(t *testing.T) {
	var err error
...
var (
	groupDBTypes = map[string]string{`ID`: `uuid`, `Name`: `character varying`, `CreatedByID`: `uuid`, `CreatedAt`: `timestamp without time zone`, `UpdatedAt`: `timestamp without time zone`, `DeletedAt`: `timestamp without time zone`}
	_            = bytes.MinRead
)
