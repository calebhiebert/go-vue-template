...
func testImagesSoftDelete(t *testing.T) {
	t.Parallel()
...
func testImagesQuerySoftDeleteAll(t *testing.T) {
	t.Parallel()
	...
	if rowsAff, err := Images().DeleteAll(ctx, tx, false); err != nil {
		t.Error(err)
	} else if rowsAff != 1 {
		t.Error("should only have deleted one row, but affected:", rowsAff)
	}
...
func testImagesSliceSoftDeleteAll(t *testing.T) {
	t.Parallel()
...
func testImagesQueryDeleteAll(t *testing.T) {
	...
	if rowsAff, err := Images().DeleteAll(ctx, tx, true); err != nil {
		t.Error(err)
	} else if rowsAff != 1 {
		t.Error("should only have deleted one row, but affected:", rowsAff)
	}
