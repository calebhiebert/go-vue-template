...
4. Copy `./env` to a new file `./.env` and make any neccecary changes
5. Start up the supporting services using the `docker-compose.dev.yml` docker-compose file
6. Start up the go service
